 ...
 * @author FIRAS
 */
public class Listeformation extends BaseForm {
        Form current ;
       public Listeformation(Resources res ) {
        ...
        ArrayList<Formation>list = ServiceFormation.getInstance().affichageFormation();
  ...
  private void addTab(Tabs swipe, Label spacer , Image image, String string, String text, Resources res) {
    ...
    private void addButton(Image img,Formation fo , Resources res) {
        ...
        Label objetTxt = new Label("titre : "+fo.getTitre(),"NewsTopLine2");
        Label descTxt = new Label("description : "+fo.getDescription(),"NewsTopLine2");
        Label typeTxt = new Label("type : "+fo.getType(),"NewsTopLine2" );
        Label paysTxt = new Label("pays : "+fo.getPays(),"NewsTopLine2" );
        Label debutTxt = new Label("debut : "+fo.getDebut(),"NewsTopLine2" );
        Label finTxt = new Label("fin : "+fo.getFin(),"NewsTopLine2" );
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce Formation ?","Annuler","Oui")) {
                dig.dispose();
       ...
       cnt.add(BorderLayout.WEST, BoxLayout.encloseY(
        BoxLayout.encloseX(objetTxt,lSupprimer,lModifier),
        BoxLayout.encloseX(descTxt),
        BoxLayout.encloseX(typeTxt),
        BoxLayout.encloseX(paysTxt),
        BoxLayout.encloseX(debutTxt),
        BoxLayout.encloseX(finTxt))); 
