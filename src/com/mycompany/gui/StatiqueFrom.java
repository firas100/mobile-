 ...
 * @author FIRAS
 */
public class StatiqueFrom extends BaseForm{
    ...
    private double nbr_participe = 34;
    private double nbr_formation = 29;
   
    Form current;
BaseForm form;
        public StatiqueFrom(Resources res)  {
        ...
        addTab(swipe, res.getImage("logo.png"), spacer1, "Acceuill");
        ...
        RadioButton all = RadioButton.createToggle("Formation", barGroup);
       
        all.setUIID("SelectBar");
        //RadioButton popular = RadioButton.createToggle("Categorie Reclamation", barGroup);
        //popular.setUIID("SelectBar");
//        RadioButton feedback = RadioButton.createToggle("Formation", barGroup);
...
//        });
  ...
  ;       
       ...
       image.addActionListener(e -> {
           try{
           new AjouterFormationForm(Resources.getGlobalResources()).show();
           }catch(Exception exx) {
    ...
    public void createPieChartForm() {
        ...
        double total = nbr_participe + nbr_formation;
        
        //values
        double prcntFeed = (nbr_participe *100)/total;
        
        double prcntRec = (nbr_formation * 100)/total;
...
//        add(cnt);
    ...
    private CategorySeries buildDataset(String title, double prcntFeed, double prcntRec) {
        ...
        series.add("Formation",prcntRec);
        series.add("Participants",prcntFeed);
